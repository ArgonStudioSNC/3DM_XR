...
public class UIManager3DM : DoubleTapHandler
{
    ...
    {
        return TransitionManager.Globals.IsFullscreenMode && TransitionManager.Globals.InAR && Input.GetButtonDown("Fire1") && !m_touchEventManager.UIHit && !m_touchEventManager.raycastHit.collider;
    }
