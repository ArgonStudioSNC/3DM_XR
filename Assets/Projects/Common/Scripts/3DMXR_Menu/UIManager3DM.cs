...
public class UIManager3DM : DoubleTapHandler
{
    ...
    {
        return TransitionManager.isFullscreenMode && mTransitionManager.InAR && Input.GetButtonDown("Fire1") && !mTouchEventManager.UIHit && !mTouchEventManager.raycastHit.collider;
    }
